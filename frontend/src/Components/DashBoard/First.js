...
export default function First() {
    ...
    function createCard(Vegetable_Name, Category_Name, items_center, img) {
        return { Vegetable_Name, Category_Name, items_center, img };
    }
                                ...
                                <Grid item xs={12} md={12} lg={12} sx={{ mt: 1 }}>
                                    <TableContainer component={Paper} sx={{ height: 300 }}>
                                        <Table stickyHeader>
                                            <TableHead >
                                                <TableRow  >
                                                    <TableCell  sx={{ color: '#fff', fontSize: 16 , backgroundColor: '#53B175'}} align="center">Order id</TableCell>
                                                    <TableCell sx={{ color: '#fff', fontSize: 16, backgroundColor: '#53B175' }} align="center">Customer Name</TableCell>

                                                    <TableCell sx={{ color: '#fff', fontSize: 16, backgroundColor: '#53B175' }} align="center">Email</TableCell>
                                                    <TableCell sx={{ color: '#fff', fontSize: 16, backgroundColor: '#53B175' }} align="center">Phone No</TableCell>
                                                    <TableCell sx={{ color: '#fff', fontSize: 16, backgroundColor: '#53B175' }} align="center">Status</TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody>
                                                {data.map((userData) => (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="center">{userData.Customer_Name}</TableCell>
                                                        <TableCell align="center">{userData.Email}</TableCell>
                                                        <TableCell align="center">{userData.Mobile}</TableCell>
                                                        <>
                                                            {
                                                                userData.Status === "Delivered"
                                                                    ? <TableCell sx={{ fontSize: 16, color: 'green' }} align="center">{userData.Status}</TableCell>
                                                                    : userData.Status === "Cancelled"
                                                                        ? <TableCell sx={{ fontSize: 16, color: '#Ea3a3a'}} align="center" >{userData.Status}</TableCell>
                                                                        : userData.Status === "Dispatched"
                                                                            ? <TableCell sx={{ fontSize: 16, color: '#2596be' }} align="center">{userData.Status}</TableCell>
                                                                            : <TableCell sx={{ fontSize: 16,  color: 'orange' }} align="center" >{userData.Status}</TableCell>
                                                            }
                                                        </>

                                                        {/* // <TableCell sx={{fontSize: 16}} align="center" sx={{color: 'green'}}>{userData.Status}</TableCell> */}
                                        ...
                                        <Card sx={{ mt: 2, bgcolor: '#f5f5f5'}} key={card.taskName}>
                                            <CardHeader
                                                ...
                                                action={
                                                    ...
                                                    <>
                                                        {(() => {
                                                            if (card.items_center < 1) {
                                                                return (
                                                                    <Typography variant="h7" sx={{ color: "gray" }} gutterBottom>Out of Stock</Typography>
                                                                )
                                                            }

                                                            return (<Typography variant="h7" sx={{ color: "gray" }} gutterBottom>only {card.items_center} kg left</Typography>);
                                                        })()}
                                                    </>
